...
//https://vercel.com/docs/integrations/ai/perplexity -- latest
...
export async function POST(req: Request) {
  ...
  const result = await streamText({
    ...
    messages, // - latest
    maxTokens: 700,
//additional objects in streamText such as maxTokens and system is from here:   https://sdk.vercel.ai/docs/reference/ai-sdk-core/stream-text
  });
